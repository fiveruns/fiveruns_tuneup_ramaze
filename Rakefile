...
spec = Gem::Specification.new do |s|
  ...
  s.email = EMAIL
  s.homepage = HOMEPAGE
  s.add_dependency('fiveruns_tuneup_core', '>= 0.5.2')
  s.require_path = 'lib'
  s.files = %w(README.rdoc Rakefile CHANGELOG) + FileList["{lib,assets,test}/**/*"]
end
